<?php
  ...
  <script type="application/ld+json">
  {
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https://www.nw-builds.com/new-world-pvp-guide"
    },
    "publisher": {
      "@type": "Organization",
      "name": "NW Builds",
...
<body>
  ...
  <div class="container">
    <div>
      ...
      <h1 class="titul">New World PvP Guide 2025 – How to Actually Win in Aeternum</h1>
      <p class="muted">Become harder to kill and far more dangerous. Settings, stamina, consumables, and weapon-specific tricks that actually work.</p>
      <div class="meta">
    ...
    <div class="grid two">
      <article>
          <div class="callout">
        How to ACTUALLY Be Good at PvP in New World Aeternum (Complete Guide 2025)<br><br>
        <iframe width="560" height="315" src="https://www.youtube.com/embed/zvn55CRA4Vw?si=CTjvfmRjx3-KXsev" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
        </div>
        <section id="best-pvp-settings">
            <div class="callout">
          PvP in <em>New World: Aeternum</em> isn’t just about gear — it’s about positioning, stamina discipline, cooldown timing, and tiny advantages that decide who wins.
            </div>
          <h2>Best PvP Settings</h2>
          <p>Fix these settings first for instant clarity and control:</p>
          <ul>
        ...
        <section id="stamina-management">
          ...
          <p><strong>Avoid grey barring.</strong> When you run out of stamina, you’re exhausted and easy to CC-chain.</p>
          <ul>
            <li>Don’t spam dodge — one dodge usually breaks tracking.</li>
            <li>Keep a buffer: never dodge below 50 stamina (55 in heavy).</li>
            <li>Absorb a hit if needed; exhaustion is worse than damage.</li>
          </ul>
        </section>

        <section id="positioning-fundamentals">
          <h2>Positioning Fundamentals</h2>
          <ul>
            <li>Use terrain for line of sight (rocks, walls, trees).</li>
            <li>Seek elevation for vision and safety.</li>
            <li>Check behind you often to avoid ambushes.</li>
            <li>Zigzag under ranged fire — never run straight.</li>
            <li>Dodge <em>before</em> CC lands, not after.</li>
          </ul>
        </section>

        <section id="cooldown--engagement-timing">
          <h2>Cooldown &amp; Engagement Timing</h2>
          <ul>
            <li>Learn enemy builds to predict weakness windows.</li>
            <li>Engage <strong>after</strong> they burn major cooldowns (e.g., Spear <em>Sweep</em>).</li>
            <li>Don’t fight without your own defensive skills/potions.</li>
            <li>Pre-pot buffs like <strong>Serum</strong> for early momentum.</li>
          </ul>
        </section>

        <section id="how-to-disengage">
          <h2>How to Disengage</h2>
          <ul>
            <li>Always know your escape route.</li>
            <li>Don’t panic dodge — wait for recovery windows (e.g., GA <em>Reap</em> follow-up).</li>
            <li>Retreat while facing the fight; use ranged pressure.</li>
            <li>Use CC defensively: <em>Shockwave</em>, <em>Sweep</em>, <em>Trip</em>.</li>
          </ul>
        </section>

        <section id="consumable-mastery">
          <h2>Consumable Mastery</h2>
          <p>Potions and runes separate average players from great ones.</p>

          <h3>Endless Thirst vs Ankh</h3>
          <table>
            <thead>
              <tr>
                <th>Rune</th>
            ...
            <tbody>
              <tr>
                <td><strong>Endless Thirst</strong></td>
                <td>Rotate potion types to bypass increased cooldowns</td>
                <td>~133% potion power, long sustain</td>
                <td>Requires active rotation</td>
              </tr>
              <tr>
                <td><strong>Ankh</strong></td>
                <td>Boosts healing received</td>
                <td>Simple sustain option</td>
                <td>Potions only ~75% effective</td>
              </tr>
            </tbody>
          </table>
        ...
        <section id="tiny-details-that-win-fights">
          <h2>Tiny Details That Win Fights</h2>
          <ul>
      ...
      <aside class="sticky-sidebar">
        <nav class="card toc" aria-label="On this page">
          ...
          <ol>
            <li><a href="#best-pvp-settings">Best PvP Settings</a></li>
            <li><a href="#stamina-management">Stamina Management</a></li>
            <li><a href="#positioning-fundamentals">Positioning Fundamentals</a></li>
            <li><a href="#cooldown--engagement-timing">Cooldown &amp; Engagement</a></li>
            <li><a href="#how-to-disengage">How to Disengage</a></li>
            <li><a href="#consumable-mastery">Consumable Mastery</a></li>
            <li><a href="#universal-pvp-habits">Universal Habits</a></li>
            <li><a href="#weapon-specific-tips">Weapon Tips</a></li>
            <li><a href="#target-priority">Target Priority</a></li>
            <li><a href="#tiny-details-that-win-fights">Tiny Details</a></li>
        ...
        <div class="card" style="margin-top:16px">
          <h3>Quick Tips</h3>
          <ul>
            <li>Never dodge below 50 stamina (55 in heavy).</li>
            <li>Pre-pot Serum + Regen before fights.</li>
            <li>Time CC at the end of enemy casts.</li>
            <li>Block light strings, not heavy swings.</li>
          </ul>
        </div>
